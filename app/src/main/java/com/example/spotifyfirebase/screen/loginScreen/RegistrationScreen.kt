...
import com.example.spotifyfirebase.screen.loginScreen.view.TextFieldBase
...
fun RegistrationScreen(
    ...
    val registrationValidate = remember { mutableStateOf("") }

    loginViewModel.responseValidate.onEach {
        registrationValidate.value = it
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = registrationValidate.value,
                color = Color.Red,
